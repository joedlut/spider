# Generated by Django 4.1.5 on 2023-01-08 09:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_city', models.SmallIntegerField(choices=[(0, '北京'), (1, '深圳'), (2, '上海')], verbose_name='工作地点')),
                ('job_duty', models.TextField(max_length=1024, verbose_name='职位职责')),
                ('job_requirment', models.TextField(max_length=1024, verbose_name='职位要求')),
